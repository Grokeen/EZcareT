...
SELECT
   ...
   ,NVL(APPOLTRT.EDIT_ID,'MIG00')                              AS LSH_STF_NO	    -- '최종변경직원번호'
   ,NVL(APPOLTRT.EDIT_DTM, SYSDATE)                            AS LSH_DTM	        -- '최종변경일시'
